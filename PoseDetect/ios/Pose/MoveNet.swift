...
public final class MoveNet: PoseEstimator {
  ...
  init(threadCount: Int, delegate: Delegates, modelPath: String) throws {
  ...
  public func estimateSinglePose(on pixelBuffer: CVPixelBuffer) throws -> (Person, Times) {
    ...
    guard var result = postprocess(imageSize: pixelBuffer.size, modelOutput: outputTensor) else {
    ...
    // TODO: make function
//      print(result.keyPoints[0].bodyPart.rawValue, result.keyPoints[0].coordinate)
//      print(result.keyPoints[1].bodyPart.rawValue, result.keyPoints[1].coordinate)
//      print(result.keyPoints[2].bodyPart.rawValue, result.keyPoints[2].coordinate)
//      print(result.keyPoints[3].bodyPart.rawValue, result.keyPoints[3].coordinate)
//      print(result.keyPoints[4].bodyPart.rawValue, result.keyPoints[4].coordinate)
//      print(result.keyPoints[5].bodyPart.rawValue, result.keyPoints[5].coordinate)
//      print(result.keyPoints[6].bodyPart.rawValue, result.keyPoints[6].coordinate)
//      print(result.keyPoints[7].bodyPart.rawValue, result.keyPoints[7].coordinate)
//      print(result.keyPoints[8].bodyPart.rawValue, result.keyPoints[8].coordinate)
//      print(result.keyPoints[9].bodyPart.rawValue, result.keyPoints[9].coordinate)
//      print(result.keyPoints[10].bodyPart.rawValue, result.keyPoints[10].coordinate)
//      print(result.keyPoints[11].bodyPart.rawValue, result.keyPoints[11].coordinate)
//      print(result.keyPoints[12].bodyPart.rawValue, result.keyPoints[12].coordinate)
//      print(result.keyPoints[13].bodyPart.rawValue, result.keyPoints[13].coordinate)
//      print(result.keyPoints[14].bodyPart.rawValue, result.keyPoints[14].coordinate)
//      print(result.keyPoints[15].bodyPart.rawValue, result.keyPoints[15].coordinate)
//      print(result.keyPoints[16].bodyPart.rawValue, result.keyPoints[16].coordinate)
//      print("*********************")
      
      var x0 = result.keyPoints[0].coordinate.x
      var y0 = result.keyPoints[0].coordinate.y
      var x1 = result.keyPoints[1].coordinate.x
      var y1 = result.keyPoints[1].coordinate.y
      var x2 = result.keyPoints[2].coordinate.x
      var y2 = result.keyPoints[2].coordinate.y
      var x3 = result.keyPoints[3].coordinate.x
      var y3 = result.keyPoints[3].coordinate.y
      var x4 = result.keyPoints[4].coordinate.x
      var y4 = result.keyPoints[4].coordinate.y
      var x5 = result.keyPoints[5].coordinate.x
      var y5 = result.keyPoints[5].coordinate.y
      var x6 = result.keyPoints[6].coordinate.x
      var y6 = result.keyPoints[6].coordinate.y
      var x7 = result.keyPoints[7].coordinate.x
      var y7 = result.keyPoints[7].coordinate.y
      var x8 = result.keyPoints[8].coordinate.x
      var y8 = result.keyPoints[8].coordinate.y
      var x9 = result.keyPoints[9].coordinate.x
      var y9 = result.keyPoints[9].coordinate.y
      var x10 = result.keyPoints[10].coordinate.x
      var y10 = result.keyPoints[10].coordinate.y
      var x11 = result.keyPoints[11].coordinate.x
      var y11 = result.keyPoints[11].coordinate.y
      var x12 = result.keyPoints[12].coordinate.x
      var y12 = result.keyPoints[12].coordinate.y
      var x13 = result.keyPoints[13].coordinate.x
      var y13 = result.keyPoints[13].coordinate.y
      var x14 = result.keyPoints[14].coordinate.x
      var y14 = result.keyPoints[14].coordinate.y
      var x15 = result.keyPoints[15].coordinate.x
      var y15 = result.keyPoints[15].coordinate.y
      var x16 = result.keyPoints[16].coordinate.x
      var y16 = result.keyPoints[16].coordinate.y
      var neck_x1 = x5
      var neck_y1 = y5
      var neck_x2 = x6
      var neck_y2 = y6
      ...
      var neck_x = (x5 + x6) / 2
      var neck_y = (y5 + y6) / 2
      var pelvis_x = (x11 + x12) / 2
      var pelvis_y = (y11 + y12) / 2
      var A_x = Float(neck_x - pelvis_x)
      var A_y = Float(neck_y - pelvis_y)
      var B_x = Float(0 - pelvis_x)
      var B_y = Float(1 - pelvis_y)
      func mynorm(x:Float, y:Float) -> Float {
          return sqrt((x*x + y*y))
      }
      func get_angles(x1:Float, y1:Float, x2:Float, y2:Float) -> Float {
          var c = (x1*x2 + y1*y2)/(mynorm(x:x1,y:y1)*mynorm(x:x2,y:y2))
          return acos(c)*180/Float.pi
      }
      var spine = get_angles(x1:A_x,y1:A_y,x2:B_x,y2:B_y)
//      print("spine : \(spine)")
      var height: Float
      if y16 > y15 {
//              height = Float(y16)
          height = Float(y16 - y0) // more correct!
      } else {
//              height = Float(y15 - head_y)
          height = Float(y15 - y0) // more correct!
      }
//          var hand_y_r = Float(y9 - head_y)
      var hand_y_r = Float(y9 - y0) // more correct!
      var hand_proportion = hand_y_r / height
//      print("hand_proportion : \(hand_proportion)")
//          var hand_dist_x = Float(pelvis_x - CGFloat(A_x))
//          var hand_dist_y = Float(pelvis_y - CGFloat(A_y))
//          var spine_x = Float(neck_x - pelvis_x)
//          var spine_y = Float(neck_y - pelvis_y)
//          //     var hand_dist = mynorm(x:hand_dist_x, y:hand_dist_y) / mynorm(x:spine_x, y:spine_y)
//          var hand_dist = mynorm(x:hand_dist_x, y:hand_dist_y) / height
//          print("hand_dist : \(hand_dist)")
      var pose_class = "None"
      if (50 < spine) && (spine < 70) && (0.4 < hand_proportion && hand_proportion < 0.5) {
//          print("adress")
          result.poseClass = "address"
          result.poseScore = 0.5 // TODO FIXME
      }
...
//    if result.keyPoints.spine > 50 and result.keyPoints.spine < 70:
//        pose_class = "address"
//    print(type(of: result.keyPoints[0].coordinate))
    ...
    return (result, times)
//    return (result, times, pose_class)
  }
...
public struct TorsoAndBodyDistance {
